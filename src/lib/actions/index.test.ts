...
describe("Database Actions", () => {
    ...
    beforeEach(() => {
        ...
        History.createUndoTriggers(db, mockTableName);
    });
    ...
    describe("insert", () => {
        ...
        describe("undo and redo", () => {
            ...
            it('should undo, redo, and undo multiple creation actions across multiple tables when "useNextUndoGroup" is false', () => {
                ...
                History.createUndoTriggers(db, table1);
                History.createUndoTriggers(db, table2);
                ...
                expect(resultTable1.error).toBeFalsy();
                expect(resultTable2.success).toBe(true);
                expect(resultTable2.error).toBeFalsy();
    ...
    describe("getItemsByColValue", () => {
        ...
        it("should handle invalid column names", () => {
            ...
            const response = DbActions.createItems<Row, NewRow>({
                items,
                db,
                tableName: mockTableName,
                useNextUndoGroup: true,
